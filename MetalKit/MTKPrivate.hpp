...
#define _MTK_PRIVATE_CLS(symbol) (MTK::Private::Class::s_k##symbol)
#define _MTK_PRIVATE_SEL(accessor) (MTK::Private::Selector::s_k##accessor)

#if defined(MTK_PRIVATE_IMPLEMENTATION)

#ifdef METALCPP_SYMBOL_VISIBILITY_HIDDEN
#define _MTK_PRIVATE_VISIBILITY __attribute__((visibility("hidden")))
#else
...
#define _MTK_PRIVATE_OBJC_GET_PROTOCOL(symbol) ((__bridge void*)objc_getProtocol(#symbol))
#else
#define _MTK_PRIVATE_OBJC_LOOKUP_CLASS(symbol) objc_lookUpClass(#symbol)
#define _MTK_PRIVATE_OBJC_GET_PROTOCOL(symbol) objc_getProtocol(#symbol)
#endif

#define _MTK_PRIVATE_DEF_CLS(symbol) void* s_k##symbol _MTK_PRIVATE_VISIBILITY = _MTK_PRIVATE_OBJC_LOOKUP_CLASS(symbol)
#define _MTK_PRIVATE_DEF_PRO(symbol) void* s_k##symbol _MTK_PRIVATE_VISIBILITY = _MTK_PRIVATE_OBJC_GET_PROTOCOL(symbol)
#define _MTK_PRIVATE_DEF_SEL(accessor, symbol) SEL s_k##accessor _MTK_PRIVATE_VISIBILITY = sel_registerName(symbol)

#define _MTK_PRIVATE_DEF_STR(type, symbol)                \
    _MTK_EXTERN type const MTK##symbol _MTK_PRIVATE_IMPORT; \
    type const             symbol = (nullptr != &MTK##symbol) ? MTK##symbol : nullptr

#else

#define _MTK_PRIVATE_DEF_CLS(symbol) extern void* s_k##symbol
#define _MTK_PRIVATE_DEF_PRO(symbol) extern void* s_k##symbol
#define _MTK_PRIVATE_DEF_SEL(accessor, symbol) extern SEL s_k##accessor
#define _MTK_PRIVATE_DEF_STR(type, symbol) extern type const MTK::symbol
...
namespace Protocol
{
    _MTK_PRIVATE_DEF_PRO(MTKViewDelegate);
} // Protocol

namespace Selector
{
    _MTK_PRIVATE_DEF_SEL(alloc, "alloc");
    _MTK_PRIVATE_DEF_SEL(init, "init");
    ...
    _MTK_PRIVATE_DEF_SEL(colorspace, "colorspace");
    _MTK_PRIVATE_DEF_SEL(currentDrawable, "currentDrawable");
    _MTK_PRIVATE_DEF_SEL(currentRenderPassDescriptor, "currentRenderPassDescriptor");
    ...
    _MTK_PRIVATE_DEF_SEL(enableSetNeedsDisplay, "enableSetNeedsDisplay");
    ...
    _MTK_PRIVATE_DEF_SEL(initWithCoder_, "initWithCoder:");
    ...
    _MTK_PRIVATE_DEF_SEL(newMeshesFromAsset_device_sourceMeshes_error_, "newMeshesFromAsset:device:sourceMeshes:error:");
    _MTK_PRIVATE_DEF_SEL(newTextureWithCGImage_options_completionHandler_, "newTextureWithCGImage:options:completionHandler:");
    _MTK_PRIVATE_DEF_SEL(newTextureWithCGImage_options_error_, "newTextureWithCGImage:options:error:");
    _MTK_PRIVATE_DEF_SEL(newTextureWithContentsOfURL_options_completionHandler_, "newTextureWithContentsOfURL:options:completionHandler:");
    _MTK_PRIVATE_DEF_SEL(newTextureWithContentsOfURL_options_error_, "newTextureWithContentsOfURL:options:error:");
    _MTK_PRIVATE_DEF_SEL(newTextureWithData_options_completionHandler_, "newTextureWithData:options:completionHandler:");
    _MTK_PRIVATE_DEF_SEL(newTextureWithData_options_error_, "newTextureWithData:options:error:");
    _MTK_PRIVATE_DEF_SEL(newTextureWithMDLTexture_options_completionHandler_, "newTextureWithMDLTexture:options:completionHandler:");
    _MTK_PRIVATE_DEF_SEL(newTextureWithMDLTexture_options_error_, "newTextureWithMDLTexture:options:error:");
    _MTK_PRIVATE_DEF_SEL(newTextureWithName_scaleFactor_bundle_options_completionHandler_, "newTextureWithName:scaleFactor:bundle:options:completionHandler:");
    ...
    _MTK_PRIVATE_DEF_SEL(newTextureWithName_scaleFactor_displayGamut_bundle_options_completionHandler_, "newTextureWithName:scaleFactor:displayGamut:bundle:options:completionHandler:");
    _MTK_PRIVATE_DEF_SEL(newTextureWithName_scaleFactor_displayGamut_bundle_options_error_, "newTextureWithName:scaleFactor:displayGamut:bundle:options:error:");
    _MTK_PRIVATE_DEF_SEL(newTexturesWithContentsOfURLs_options_completionHandler_, "newTexturesWithContentsOfURLs:options:completionHandler:");
    _MTK_PRIVATE_DEF_SEL(newTexturesWithContentsOfURLs_options_error_, "newTexturesWithContentsOfURLs:options:error:");
    _MTK_PRIVATE_DEF_SEL(newTexturesWithNames_scaleFactor_bundle_options_completionHandler_, "newTexturesWithNames:scaleFactor:bundle:options:completionHandler:");
    _MTK_PRIVATE_DEF_SEL(newTexturesWithNames_scaleFactor_displayGamut_bundle_options_completionHandler_, "newTexturesWithNames:scaleFactor:displayGamut:bundle:options:completionHandler:");
    ...
    _MTK_PRIVATE_DEF_SEL(setDepthStencilPixelFormat_, "setDepthStencilPixelFormat:");
    ...
    _MTK_PRIVATE_DEF_SEL(setPreferredFramesPerSecond_, "setPreferredFramesPerSecond:");
    _MTK_PRIVATE_DEF_SEL(setPresentsWithTransaction_, "setPresentsWithTransaction:");
